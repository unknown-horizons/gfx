...
# for 8 rotations the rotation must set as pi/4
UNIT = range(0, 360, 45)
...
def start_rendering(where):
    for rotation in BUILDING_OR_UNIT:
        ...
        # rotation for 4 rotations: pi/2 and for 8 rotations pi/4
        bpy.context.scene.objects['Empty'].rotation_euler[2] -= pi / 4
